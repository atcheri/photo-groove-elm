port module PhotoGroove exposing (Model, Msg(..), Photo, Status(..), initialModel, photoDecoder, update, urlPrefix, view)
...
-- let
--     detaillUserSlideTo : Decoder Int
--     detaillUserSlideTo =
--         at [ "detail", "userStlideTo" ] int
--     msgDecoder : Decoder msg
--     msgDecoder =
--         Json.Decode.map toMsg detaillUserSlideTo
-- in
-- on "slide" msgDecoder
